...
import { withRetry, checkRateLimit } from "../api/retry.js";
...
/**
 * Search for repositories with commits in a date range using a base query, peeling sequentially
 * on incomplete results and accepting partial results for single-day overloads.
