 ...
 */
async function findReposWithCommitsInPeriod(username, startDate, endDate) {
  console.log(
    `Finding repositories with commits in period ${startDate} to ${endDate}...`
  );
  ...
  try {
    ...
    console.log(
      `GitHub reports approximately ${expectedTotalCount} total commits in this period`
    );
    let page = 1;
