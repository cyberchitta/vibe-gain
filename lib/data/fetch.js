...
import { createNodePeriodDataManager } from "../../core/data/period-data-manager.js";
...
export async function fetchCommits(
  ...
  try {
    ...
    const { commits, repoMetadata } = await dataManager.loadPeriodData(
      periodName
    );
    ...
    if (commitData.length > 0) {
      await dataManager.savePeriodData(periodName, commitData, repoMetadata);
