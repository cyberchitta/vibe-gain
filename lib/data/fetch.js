...
export async function fetchCommits(
  ...
  try {
    ...
    cacheStats.privatePercentage = (cacheStats.privateCommits / cachedCommitCount) * 100;
    cacheStats.forkPercentage = (cacheStats.forkCommits / cachedCommitCount) * 100;
    ...
    if (expectedTotalCount && cachedCommitCount < expectedTotalCount * 0.9) {
      ...
      cacheStats.missingPercentage = (cacheStats.missingCommits / expectedTotalCount) * 100;
    }
